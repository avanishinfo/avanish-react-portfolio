...
const Data = () => {
    return (
       <div className="home__data">
        <h1 className="home__title">Avanish Singh
        ...
        <p className="home__description">Hey there, i'm avanish java developer based in India, and I am very passionate and dedicated to my work.</p>
